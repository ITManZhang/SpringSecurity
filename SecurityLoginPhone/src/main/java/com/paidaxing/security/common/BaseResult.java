...
public class BaseResult<T> {
    ...
    public static <T> BaseResult<T> ok(String message){
        return new BaseResult<>(ResultCode.SUCCESS.getCode(), message);
    }
    ...
    public static <T> BaseResult<T> fail(String message){
        return new BaseResult<>(ResultCode.FAIL.getCode(), message);
    }
    ...
    public static <T> BaseResult<T> fail(String message, T data){
        return new BaseResult<>(ResultCode.FAIL.getCode(), message, data);
    }
